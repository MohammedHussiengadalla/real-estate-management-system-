...
namespace project
{
    public partial class update_information_of_flat_by_admin : Form
    {
        public update_information_of_flat_by_admin()
        {
            InitializeComponent();
        }

        private void update_information_of_flat_by_admin_Load(object sender, EventArgs e)
        {
